...
<div class="hero-block">
  ...
  <div class="hero-img">
    <?php if($bannerNotice->file && preg_match('/\.(jpg|jpeg|png|gif|webp)$/i', $bannerNotice->file)): ?>
      <img
        src="<?php echo e(asset('storage/'.$bannerNotice->file)); ?>"
        alt="<?php echo e($bannerNotice->title); ?>"
        loading="eager"
      >
    <?php else: ?>
      
      <img
        src="https://upload.wikimedia.org/wikipedia/commons/thumb/f/f9/National_Martyrs%27_Memorial_Savar.jpg/320px-National_Martyrs%27_Memorial_Savar.jpg"
        alt="জাতীয় স্মৃতিসৌধ"
        loading="lazy"
  ...
  <div class="hero-body">
    ...
    <?php if($bannerNotice->file): ?>
      <a
        href="<?php echo e(asset('storage/'.$bannerNotice->file)); ?>"
        target="_blank"
        class="hero-link"
      ><?php echo e($bannerNotice->description ?? 'সুবর্ণজয়ন্তী ছবির গ্যালারী'); ?></a>
    <?php endif; ?>
        ...
        <ul class="notice-list">
          <?php $__currentLoopData = $notices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <li>
              <?php if($notice->file): ?>
                <a
                  href="<?php echo e(asset('storage/'.$notice->file)); ?>"
                  target="_blank"
                  rel="noopener"
                ><?php echo e($notice->title); ?></a>
              <?php else: ?>
    ...
    <?php if($newsItems->count()): ?>
      <span class="ticker-scroll" aria-live="polite">
        <?php $__currentLoopData = $newsItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ni): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <?php if($ni->link): ?>
            <a href="<?php echo e($ni->link); ?>" target="_blank" rel="noopener">&nbsp;&nbsp;<?php echo e($ni->title); ?></a>
          <?php else: ?>
            &nbsp;&nbsp;<?php echo e($ni->title); ?>
      ...
      <?php if($downloads->count()): ?>
        <ul class="dl-list">
          <?php $__currentLoopData = $downloads; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <li>
              <a
                href="<?php echo e(asset('storage/'.$dl->file)); ?>"
                target="_blank"
                rel="noopener"
              ><?php echo e($dl->title); ?></a>
            </li>
          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </ul>
      <?php else: ?>
...
<?php echo $__env->make('layouts.frontend', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\mmdri\Downloads\goblav\resources\views/frontend/pages/home.blade.php ENDPATH**/ ?>